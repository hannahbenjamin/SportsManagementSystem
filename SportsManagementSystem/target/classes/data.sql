...
INSERT INTO students (id, firstName, lastName, email) VALUES (4444, 'Daenerys', 'Targaryen', 'daenerys.targaryen@mail.univ.ca');
...
-- LAB 2: Add classrooms
INSERT INTO classrooms (code, capacity) VALUES ('MB123', 100);
INSERT INTO classrooms (code, capacity) VALUES ('BA1130', 30);

-- LAB 4: Make each course associated with a classroom
INSERT INTO courses(code, name, professorId, classroomCode) VALUES ('GOT123', 'A Game of Thrones', 1122, 'BA1130');
INSERT INTO courses(code, name, professorId, classroomCode) VALUES ('GOT456', 'A Clash of Kings', 3344, 'BA1130');
INSERT INTO courses(code, name, professorId, classroomCode) VALUES ('GOT789', 'A Storm of Swords', 5566, 'MB123');
